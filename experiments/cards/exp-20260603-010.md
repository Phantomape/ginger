...
- experiment_id: `exp-20260603-010`
- timestamp: `2026-06-03T09:14:24+00:00`
- decision: `rejected_positive_not_promotable`

## Hypothesis

PIT-safe Form 4 meaningful-purchase events with aggregate purchase shares / aggregate reported after-transaction shares >= 10% may be a cleaner free SEC candidate source than raw meaningful-purchase events.
...
The aggregate ownership-delta slice was positive versus core, but it failed the full Gate 4 standard after raw Form 4 replacement, materiality, sample, window, drawdown, and concentration checks.
...
```json
{
  ...
  "promotion_blocker_if_positive": "A shared default-off Form 4 aggregate ownership-delta adapter and parity test are required before production use.",
  "replay_only": true,
