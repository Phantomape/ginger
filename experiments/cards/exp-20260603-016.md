# exp-20260603-016 accepted free-data cross-source consensus

- Trial family: `accepted_free_data_cross_source_consensus_new_independent_source_family`
- Changed variable: `volatility_contraction_source_family_presence_added_to_independent_consensus_v1`
- Decision: `rejected_vcp_source_family_underperforms_current_accepted_consensus`
- Aggregate EV delta: +0.6665
- Aggregate PnL delta: $+11,649.75
- Target trades: 59
...
|---|---:|---:|---:|---:|---:|---:|---:|
| late_strong | 10 | $3,271.32 | 5.1628 | 5.4755 | +0.3127 | $+3,271.32 | -0.0010 |
| mid_weak | 30 | $3,928.23 | 2.1402 | 2.3792 | +0.2390 | $+3,928.23 | -0.0023 |
| old_thin | 19 | $4,450.20 | 0.5911 | 0.7059 | +0.1148 | $+4,450.20 | -0.0053 |
...
This experiment changes no production code. A retained lead would need a shared default-off adapter that reconstructs the same VCP source row and independent source-family consensus in both replay and daily run paths before any candidate queue or order surface could change.
...
- `VOLATILITY_CONTRACTION_QQQ_CONFIRMED_PAPER`: `data/experiments/exp-20260526-007/vcp_rank_notional_profile.json`
