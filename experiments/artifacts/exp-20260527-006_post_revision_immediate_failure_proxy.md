# exp-20260527-006 Post-Revision Immediate Failure Proxy

Direction: `pead_continuation` round `2`.
...
```json
{
  ...
  "decision": "observed_only_data_gap",
  "preferred_10d": {
    "avg_pnl_proxy": 198.21,
    "avg_return": 0.019821,
    "closed_outcomes": 12,
    "max_single_ticker_positive_share": 0.336118,
    "positive_pnl_by_ticker": {
      "AAPL": 286.11,
      "AMD": 1023.58,
      "DDOG": 689.49,
    ...
    "tail_loss": -0.044337,
    "top5_positive_contribution_share": 0.907036,
    "total_pnl_proxy": 2378.57,
    "win_rate": 0.583333,
    "worst_row": {
      ...
      "eps_estimate_delta_7d": 0.01,
      "eps_estimate_delta_prev": 0.0,
      "forward_return": -0.044337,
      "future_date": "2026-05-25",
      "pead_status": "missing_last_earnings_date",
      "pnl_proxy": -443.37,
      "primary_expectation_positive": true,
      "residual_state": "residual_leader",
      "residual_strength_score": 0.055308,
      "ret20_excess_qqq": 0.0246,
      "ret20_excess_spy": 0.0763,
...
```json
{
  "bucket_counts": {
    ...
    "primary_7d_fast_2d_failure": 5,
    "primary_7d_missing_2d_outcome": 14,
    "primary_7d_no_fast_2d_failure": 28
  },
  ...
  "primary_7d_missing_2d_outcome": {
    "horizons": {
      ...
      "1d": {
        ...
        "avg_return": 0.02892,
        "closed_outcomes": 8,
        "max_single_ticker_positive_share": 0.986107,
        "positive_pnl_by_ticker": {
          "DIS": 54.36,
          "MU": 3858.32
        },
  ...
  "primary_7d_no_fast_2d_failure": {
    "horizons": {
      ...
      "1d": {
        ...
        "avg_return": 0.006705,
        "closed_outcomes": 28,
        "max_single_ticker_positive_share": 0.366803,
        "positive_pnl_by_ticker": {
          "AAPL": 238.3,
          "APP": 326.49,
          "CAT": 144.28,
        ...
        "tail_loss": -0.025356,
        "top5_positive_contribution_share": 0.786318,
        "total_pnl_proxy": 1877.32,
        "win_rate": 0.392857,
        "worst_row": {
      ...
      "2d": {
        ...
        "avg_return": 0.0114,
        "closed_outcomes": 28,
        "max_single_ticker_positive_share": 0.340734,
        "positive_pnl_by_ticker": {
          "AAPL": 566.8,
          "APP": 326.49,
          "CAT": 251.1,
        ...
        "tail_loss": -0.011934,
        "top5_positive_contribution_share": 0.757336,
        "total_pnl_proxy": 3191.88,
        "win_rate": 0.428571,
        "worst_row": {
          "as_of_date": "2026-05-18",
          "candidate_hit_10td": false,
...
Replace this close-to-close proxy with true post-earnings gap and T+2/T+5 context once earnings dates are PIT-joined.
