# exp-20260516-006 Event Rotation-Surface Tilt Current Stack

Decision: `promising_replay_only_rotation_surface_tilt`

Alpha search, replay-only. Revalidates whether `rotation_breakout_leadership` event rows deserve a higher bounded paper notional than the current 2.0x non-generic positive event-surface add-on after the accepted exp-20260515-028 core stack.

## Best Variant Vs Current Lead

| Window | Current EV | Variant EV | Delta EV | Current PnL | Variant PnL | Delta PnL |
|---|---:|---:|---:|---:|---:|---:|
| late_strong | 5.9449 | 6.2576 | +0.3127 | $127,573.07 | $132,017.56 | $+4,444.49 |
| mid_weak | 2.8394 | 3.0555 | +0.2161 | $88,729.87 | $92,033.08 | $+3,303.21 |
| old_thin | 0.5991 | 0.6067 | +0.0076 | $39,940.19 | $40,180.39 | $+240.20 |

## Aggregate Gate

- EV delta vs current lead: +0.5364 (+5.72%)
- PnL delta vs current lead: $+7,987.90 (+3.12%)
