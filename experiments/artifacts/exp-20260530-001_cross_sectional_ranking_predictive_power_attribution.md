# exp-20260530-001 Cross-Sectional Composite alpha_score Rank Predictive-Power Attribution
...
- `quant/experiments/exp_20260530_001_cross_sectional_ranking_predictive_power_attribution.py` (new)
- `quant/test_exp_20260530_001_cross_sectional_ranking_attribution.py` (new, 6 tests)
- `data/experiments/exp-20260530-001/result_{late_strong,mid_weak,old_thin}.json` (canonical 3-window backtests)
- `data/experiments/exp-20260530-001/ranking_attr_{late_strong,mid_weak,old_thin}.json` (per-window PIT attribution)
- `data/experiments/exp-20260530-001/cross_sectional_ranking_predictive_power_attribution.json` (aggregate + judgment)
- `experiments/artifacts/exp-20260530-001_cross_sectional_ranking_predictive_power_attribution.md` (this file)
- `experiments/logs/exp-20260530-001.json`, `experiments/tickets/exp-20260530-001.json`
