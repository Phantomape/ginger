# exp-20260516-013 Event Rotation-Surface Tilt After Exp009

Decision: `promising_replay_only_rotation_surface_tilt`

Alpha search, replay-only. Revalidates whether `rotation_breakout_leadership` event rows deserve a higher bounded paper notional than the current 2.0x non-generic positive event-surface add-on after the accepted exp-20260516-009 core stack.
...
| mid_weak | 2.8340 | 3.0499 | +0.2159 | $89,118.87 | $92,422.08 | $+3,303.21 |
| old_thin | 0.5991 | 0.6067 | +0.0076 | $39,940.19 | $40,180.39 | $+240.20 |

## Aggregate Gate

- EV delta vs current lead: +0.5237 (+5.57%)
