# exp-20260527-004 Same-Event History Depth Attribution

Direction: `expectation_revision_velocity` round `3`.
...
```json
{
  ...
  "comparison_5d": {
    "avg_pnl_proxy": -166.34,
    "avg_return": -0.016634,
    "closed_outcomes": 16,
    "max_single_ticker_positive_share": 0.46627,
    "positive_pnl_by_ticker": {
      "AAPL": 67.28,
      "AMD": 553.64,
      "DDOG": 204.83,
    ...
    "tail_loss": -0.079275,
    "top5_positive_contribution_share": 0.94087,
    "total_pnl_proxy": -2661.38,
    "win_rate": 0.4375,
    "worst_row": {
      "as_of_date": "2026-05-14",
      "candidate_hit_10td": false,
  ...
  "data_gap_reasons": [
    ...
    "preferred_or_comparison_bucket_not_comparable"
  ],
  "decision": "observed_only_data_gap",
  "preferred_10d": {
    "avg_pnl_proxy": null,
  ...
  "preferred_5d": {
    "avg_pnl_proxy": 171.37,
    "avg_return": 0.017137,
    "closed_outcomes": 17,
    "max_single_ticker_positive_share": 0.400164,
    "positive_pnl_by_ticker": {
      "AAPL": 915.48,
      "CAT": 498.0,
      "COHR": 1615.17,
    ...
    "tail_loss": -0.036425,
    "top5_positive_contribution_share": 0.676798,
    "total_pnl_proxy": 2913.35,
    "win_rate": 0.647059,
    "worst_row": {
...
```json
{
  "bucket_counts": {
    ...
    "primary_7d_history_ge_10": 31,
    "primary_7d_history_lt_10": 16
  },
  ...
  "primary_7d_history_ge_10": {
    "horizons": {
      ...
      "1d": {
        ...
        "avg_return": 0.01482,
        "closed_outcomes": 25,
        "max_single_ticker_positive_share": 0.790271,
        "positive_pnl_by_ticker": {
          "AAPL": 238.3,
          "CAT": 144.28,
          "COHR": 681.64,
        ...
        "tail_loss": -0.04485,
        "top5_positive_contribution_share": 0.880851,
        "total_pnl_proxy": 3704.91,
        "win_rate": 0.56,
        "worst_row": {
      ...
      "2d": {
        "avg_pnl_proxy": 148.17,
        "avg_return": 0.014817,
        "closed_outcomes": 17,
        "max_single_ticker_positive_share": 0.374888,
        "positive_pnl_by_ticker": {
          "AAPL": 566.8,
          "CAT": 251.1,
          "COHR": 1221.08,
        ...
        "tail_loss": -0.036425,
        "top5_positive_contribution_share": 0.799748,
        "total_pnl_proxy": 2518.82,
        "win_rate": 0.647059,
        "worst_row": {
          "as_of_date": "2026-05-20",
          "candidate_hit_10td": false,
...
Keep de-duplicated PIT expectation snapshots; shallow history should stay data-accumulation only.
