...
```json
{
  ...
  "promotion_blocker_if_positive": "A shared default-off Form 4 + FINRA paper adapter must be wired through production and replay with source-row caching and parity tests before any production report or order behavior can change.",
  "replay_only": true,
