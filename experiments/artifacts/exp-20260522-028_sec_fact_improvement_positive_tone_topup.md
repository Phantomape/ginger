# exp-20260522-028 SEC Fact-Improvement Positive-Tone Top-Up

Decision: `rejected_sec_fact_improvement_positive_tone_topup`.

## Hypothesis

SEC financial-report T+1 rows with explicit improving facts and positive tone may have better replacement value than generic financial-report drift rows. A bounded paper-notional scalar tests that semantic quality bucket without changing eligibility, exits, live orders, or LLM authority.

## Trial Accounting

- trial_family: `sec_fact_tone_gap_semantic_allocation`
- changed_variable: `sec_fact_improvement_positive_tone_notional_scalar`
- prior_trial_count: `3`
...
- best_variant: `fact_improvement_positive_tone_scalar_1_50`
- target_scalar: `1.5`
- EV delta: `0.217963`
- PnL delta: `$3024.43`
- gate_passed: `False`
...
```json
{
  ...
  "by_window": {
    ...
    "mid_weak": {
      ...
      "candidate_rows": 29,
      "target_accessions": [
        "0001035267-25-000106",
        "0001321655-25-000063",
  ...
  "target_candidate_rows": 7,
  "target_share": 0.06481481481481481,
  "target_tickers": {
    "BE": 1,
    "ISRG": 1,
    "MU": 2,
