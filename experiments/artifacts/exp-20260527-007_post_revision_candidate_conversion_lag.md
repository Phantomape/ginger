# exp-20260527-007 Post-Revision Candidate Conversion Lag

Direction: `pead_continuation` round `3`.
...
```json
{
  "bucket_counts": {
    ...
    "primary_7d_no_candidate_hit_10td": 47
  },
...
Keep candidate-hit lag as read-only until it has enough positive revision conversions and earnings-date context.
