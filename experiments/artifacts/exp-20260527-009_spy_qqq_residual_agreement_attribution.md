# exp-20260527-009 SPY/QQQ Residual Agreement Attribution

Direction: `residual_leadership` round `2`.
...
```json
{
  "bucket_counts": {
    ...
    "primary_7d_leads_neither_benchmark": 15,
    "primary_7d_leads_only_one_benchmark": 9,
    "primary_7d_leads_spy_and_qqq": 23
  },
...
```json
{
    ...
    "horizons": {
      ...
      "2d": {
        ...
        "worst_row": {
          ...
          "forward_return": -0.010377,
          "future_date": "2026-05-22",
          "pead_status": "missing_last_earnings_date",
          "pnl_proxy": -103.77,
          "primary_expectation_positive": true,
          "residual_state": "beta_lagging",
          "residual_strength_score": -0.07018,
          "ret20_excess_qqq": -0.0957,
          "ret20_excess_spy": -0.0493,
  ...
  "primary_7d_leads_only_one_benchmark": {
    "horizons": {
      ...
      "1d": {
        ...
        "avg_return": -0.005188,
        "closed_outcomes": 9,
        "max_single_ticker_positive_share": 0.928025,
        "positive_pnl_by_ticker": {
          "CAT": 144.28,
          "V": 11.19
        },
  ...
  "primary_7d_leads_spy_and_qqq": {
    "horizons": {
      ...
      "1d": {
        "avg_pnl_proxy": 166.73,
        "avg_return": 0.016673,
        "closed_outcomes": 21,
        "max_single_ticker_positive_share": 0.928045,
        "positive_pnl_by_ticker": {
          "AAPL": 238.3,
          "MU": 4745.52,
          "NVDA": 129.64
        ...
        "tail_loss": -0.056927,
        "top5_positive_contribution_share": 0.953398,
        "total_pnl_proxy": 3501.3,
        "win_rate": 0.380952,
        "worst_row": {
          "as_of_date": "2026-05-14",
          "candidate_hit_10td": false,
      ...
      "2d": {
        ...
        "avg_return": 6.8e-05,
        "closed_outcomes": 19,
        "max_single_ticker_positive_share": 0.653487,
        "positive_pnl_by_ticker": {
          "AAPL": 566.8,
          "MU": 1166.48,
          "NVDA": 51.73
        ...
        "tail_loss": -0.056927,
        "top5_positive_contribution_share": 0.97102,
        "total_pnl_proxy": 12.86,
        "win_rate": 0.315789,
        "worst_row": {
          "as_of_date": "2026-05-14",
          "candidate_hit_10td": false,
...
Persist sector/theme residuals so residual leadership is not reduced to a SPY/QQQ-only proxy.
