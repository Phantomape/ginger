...
- Raw records loaded by meta report: `2559`
- History fingerprint: `e1f9aa5d90bae934`
...
- `pilot_or_sleeve` priority `0.6305`: experiments `171`, accept `25.73%`, sum EV `+66.2321`, sum PnL `$1,149,056.08`.
...
- `slot_or_ranking` priority `0.5648`: experiments `176`, accept `24.43%`, sum EV `+41.3211`, sum PnL `$741,589.21`.
  Reason: 10/176 records have sample >= 10; 168/176 records show multi-window evidence; average drawdown delta is non-worsening; mixed production feasibility evidence; positive average meta score; positive cumulative EV delta in logs
