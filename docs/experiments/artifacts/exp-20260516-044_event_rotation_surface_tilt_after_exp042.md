...
Alpha search, replay-only. Tests whether `rotation_breakout_leadership` event rows still deserve higher bounded paper notional than the current 2.0x non-generic positive event-surface add-on after the accepted exp-20260516-042 core stack.
...
| mid_weak | 2.8350 | 3.0510 | +0.2160 | $89,152.02 | $92,455.23 | $+3,303.21 |
| old_thin | 0.6637 | 0.6717 | +0.0080 | $42,272.76 | $42,512.96 | $+240.20 |

## Aggregate Gate

- EV delta vs current lead: +0.5243 (+5.53%)
- PnL delta vs current lead: $+7,987.90 (+3.08%)
