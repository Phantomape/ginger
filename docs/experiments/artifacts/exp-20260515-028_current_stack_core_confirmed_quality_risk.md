...
|---:|:---:|---:|---:|---|---|---:|---:|
| 1.025 | PASS | +0.0206 | $+900.22 | late_strong, old_thin | - | 14 | +0.0012 |
| 1.050 | PASS | +0.0576 | $+1,936.96 | late_strong, mid_weak, old_thin | - | 19 | +0.0032 |
| 1.060 | PASS | +0.0780 | $+2,431.60 | late_strong, mid_weak, old_thin | - | 19 | +0.0045 |
| 1.070 | PASS | +0.0852 | $+2,593.10 | late_strong, mid_weak, old_thin | - | 19 | +0.0049 |
| 1.075 | PASS | +0.0866 | $+2,604.84 | late_strong, mid_weak, old_thin | - | 19 | +0.0049 |
| 1.080 | FAIL | +0.0865 | $+2,813.87 | late_strong, mid_weak, old_thin | - | 20 | +0.0057 |
| 1.090 | FAIL | +0.1041 | $+2,942.63 | late_strong, mid_weak, old_thin | - | 20 | +0.0061 |
...
Production impact: promoted into shared `risk_engine.py`, `portfolio_engine.py`, `backtester.py` attribution keys, `docs/production_backtest_parity.md`, and focused parity tests. `run.py` and `backtester.py` both use the shared risk/sizing path; the experiment runner explicitly disables the promoted constant while replaying its own baseline and variant wrapper.
