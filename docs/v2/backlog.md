...
- [ ] 建立干净 Engine-0 baseline 与共享 feature/policy/DecisionRecord chain；先以 research-only clock envelope 做合同接口，任何 canonical/promotion 声称仍需动态 PIT 市场 universe、外部 anchor 及适用 parity
...
- research-only market decision clock 合同不等于 Engine-0 或 M3 完成：动态 PIT 市场 universe、共享 feature/policy/decision baseline、scheduler 与 production parity 仍未建立。
