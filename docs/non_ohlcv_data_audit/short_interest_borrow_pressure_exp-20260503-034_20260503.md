# Short Interest / Borrow Pressure Data Audit - exp-20260503-034

Date: 2026-05-03
Mode: data audit / duplicate guardrail / shadow blocked
Mechanism family: short_interest_borrow_pressure_overlay
Single causal variable: new PIT-safe short-interest or borrow-pressure evidence since exp-20260503-032
...
- exp-20260503-028: recheck, still 0 structured short-interest rows, 0 FINRA adapter/files, 0 paid borrow rows, and 0 PIT-safe rows.
- exp-20260503-032: latest exact short/borrow recheck before this run, still 0 taggable candidates.
...
| PIT-safe rows | 0 |
| data/non_ohlcv short/borrow files | 0; directory contains SEC artifacts only |
| new short/borrow files since exp-20260503-032 | 0 |
| unstructured short-interest/news headline matches | 184 matches across 37 files; not treated as structured PIT evidence |
