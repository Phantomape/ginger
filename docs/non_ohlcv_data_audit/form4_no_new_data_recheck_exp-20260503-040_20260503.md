...
- Experiment: exp-20260503-040
- Run time: 2026-05-03T16:05:45+00:00
- Decision: data_gap
...
Exact prior Form 4 audits already exist: exp-20260503-017, exp-20260503-020, exp-20260503-025, exp-20260503-026, exp-20260503-030, exp-20260503-033, and exp-20260503-037. They all found the same blocker: CIK mapping is mostly present, but transaction-level, PIT-safe Form 4 rows are absent.
...
- SEC / CIK infrastructure: present via SEC ticker mapping and submissions utilities.
...
- New relevant local Form 4 inputs after exp-20260503-037: 0.
- Current SEC news Form 4 items: 0.
- Current news source diagnostics: 8-K, 10-Q, and 10-K only; no owner=include type=4 source.
- Unstructured insider/ownership headline files: 25, but these are Google News text items, not SEC Form 4 transaction rows.
...
Decision remains data_gap. Do not promote a Form 4 overlay, do not add a production filter, and do not infer slot value from static filing metadata or unstructured selling/ownership headlines.
