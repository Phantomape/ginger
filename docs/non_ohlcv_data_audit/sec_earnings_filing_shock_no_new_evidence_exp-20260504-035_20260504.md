# SEC / Earnings / Filing Shock No-New-Evidence Audit - exp-20260504-035
...
This run did not test a new signal. It checked whether fresh PIT-safe evidence exists after `exp-20260504-033`.

## Scope

- Mechanism family: `earnings_sec_filing_shock_event_confirmation_overlay`
- Single causal variable: fresh PIT-safe SEC / earnings / filing-shock evidence since `exp-20260504-033`
...
| `exp-20260504-021`, `024`, `025`, `027`, `029`, `032`, `033` | Data audits found no production-ready filing-shock evidence or fresh closed outcomes. |
...
|---|---:|---|---|
| Current SEC feed `data/news_20260503.json` | 300 SEC items, 284 ticker-mapped | Current observed PIT feed | No closed 5/10/20/60d outcomes after `exp-20260504-033` |
