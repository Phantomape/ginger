# SEC / Earnings / Filing Shock No-New-Evidence Guardrail - exp-20260503-027

## Hypothesis

SEC filing shock, financial surprise, 8-K event type, and post-earnings drift may improve C-strategy grading or A/B event confirmation. This run only checks whether new PIT-safe evidence arrived after `exp-20260503-024`.
...
`new PIT-safe SEC / earnings filing-shock evidence since exp-20260503-024`
...
- `exp-20260503-019`, `exp-20260503-022`, `exp-20260503-024`: duplicate guardrail rechecks; no new SEC archive or XBRL/companyfacts field coverage.
...
| SEC Atom filings | Existing `data/news_20260502.json` only | Forward archive only | No new archive since `exp-20260503-024` |
...
- New rows since `exp-20260503-024`: 0
...
The SEC/earnings filing-shock branch remains worth watching, but another same-archive replay would repeat `exp-20260503-016`, `exp-20260503-019`, `exp-20260503-022`, and `exp-20260503-024`. Do not promote to production, default-off replay, C-strategy grading, or slot tie-breaker until new forward SEC archive days or PIT XBRL/companyfacts rows exist.
