# Short Interest / Borrow Pressure Data Audit - exp-20260503-028

Date: 2026-05-03
Mode: data audit / duplicate guardrail / shadow blocked
Mechanism family: short_interest_borrow_pressure_overlay
Single causal variable: new PIT-safe short-interest or borrow-pressure evidence since exp-20260503-023
...
| PIT-safe rows | 0 |
| data/non_ohlcv short/borrow files | 0; directory currently has SEC filing artifacts only |
| unstructured short-interest/news headline matches | 52; not treated as structured PIT evidence |

## PIT Risk

Short-interest settlement dates are not tradable without publication dates and a usable_trade_date. FINRA daily short volume is trading activity, not short positioning. MarketBeat/Stocktwits/news headline mentions are unstructured and do not provide a reproducible short-interest, float, borrow-fee, or shares-available time series. Without borrow_fee or shares_available, squeeze confidence must be downgraded.
...
Create a default-off append-only short/borrow adapter contract with publication-date lag handling. Rerun shadow tagging only after nonzero PIT rows exist.
