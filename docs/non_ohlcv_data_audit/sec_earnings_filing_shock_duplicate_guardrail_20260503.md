# SEC / Earnings / Filing Shock Duplicate Guardrail - exp-20260503-022

## Hypothesis

SEC filing shock, financial surprise, 8-K event type, and post-earnings drift may improve C-strategy grading or A/B event confirmation. This run only checks whether new PIT-safe evidence arrived after `exp-20260503-019`.
...
`new PIT-safe SEC / earnings filing-shock evidence since exp-20260503-019`
...
- `exp-20260503-019`: exact duplicate guardrail recheck; found no new SEC source archive or XBRL/companyfacts field coverage.
...
| SEC Atom filings | Existing `data/news_20260502.json` only | Forward archive only | No new archive since `exp-20260503-019` |
...
- New rows since `exp-20260503-019`: 0
...
The SEC/earnings filing-shock branch remains worth watching, but another same-archive replay would repeat `exp-20260503-016` and `exp-20260503-019`. Do not promote to production, default-off replay, C-strategy grading, or slot tie-breaker until new forward SEC archive days or PIT XBRL/companyfacts rows exist.
