# SEC / earnings / filing shock data audit (exp-20260503-036)

## Decision

`data_gap`. This run found no new PIT-safe SEC / XBRL / companyfacts evidence after `exp-20260503-035`, so it did not run a new shadow replay and did not touch production strategy code.
...
Exact prior same-family run: `exp-20260503-035`, also `data_gap`.

Same-family records checked: `exp-20260503-002`, `004`, `005`, `006`, `011`, `013`, `016`, `019`, `022`, `024`, `027`, `029`, `031`, `035`.
