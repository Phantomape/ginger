# SEC / Earnings Filing Shock No-New-Evidence Recheck (exp-20260503-031)

Generated: 2026-05-03T13:07:10+00:00
...
Same-family runs already exist: `exp-20260503-002`, `004`, `005`, `006`, `011`, `013`, `016`, `019`, `022`, `024`, `027`, and `029`. The latest exact prior run, `exp-20260503-029`, was also `data_gap` because the repo had one forward SEC archive, no PIT XBRL/companyfacts table, and no closed forward-return sample.

This run found no new local evidence after `exp-20260503-029`, so replaying filing severity, 8-K item type, C-strategy grading, breakout confirmation, or scarce-slot tie-breaker variants would be a duplicate same-archive rerun.
...
| Production/pilot overlap | 1 row | Too sparse | No slot conclusion |
...
| New rows since `exp-20260503-029` | 0 |
