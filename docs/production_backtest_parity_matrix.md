...
membership rows, a source-bounded dynamic PIT market-universe snapshot, and an
identity-only Engine-0 cash/no-signal baseline; it does not feed the legacy production runner,
