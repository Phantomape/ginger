# Pilot shadow tracker - as of 2026-07-21T03:55:15+00:00
...
- **DDOG**: shadow-held by 2 pilots (Source-priority allocator (TOP-1 only), Fundamental growth + RS) -> $20,000 modeled exposure
  - Source-priority allocator (TOP-1 only): EXIT_NEXT_SESSION, verdict KILL, new entries blocked
...
|---|--:|--:|--:|--:|--:|--:|--:|---|
| Source-priority allocator (TOP-1 only) | 11 | 27% | $-7,685 | $-7,685 | $-7,981 | $-5,743 | 83.2% | **KILL** |
...
- **SHADOW SELL (EXIT_NEXT_SESSION; VERIFY BROKER)** DDOG: hold elapsed (day 9/10); entry 252.63, last 263.20
...
- _skip_ CHRD (SKIP_pilot_kill_verdict)
...
- _skip_ ELF (SKIP_pilot_kill_verdict)

### Fundamental growth + RS  (`fundamental_growth_rs`, max_concurrent=None)
- _new entries blocked: KILL verdict_
- **SHADOW SELL (EXIT_NEXT_SESSION; VERIFY BROKER)** AMD: hold elapsed (day 9/10); entry 544.28, last 503.57
- **SHADOW SELL (EXIT_NEXT_SESSION; VERIFY BROKER)** MU: hold elapsed (day 9/10); entry 965.56, last 865.46
- shadow hold DDOG: day 2/10 (8 left); entry 256.40, last 263.20 (+2.6%)
