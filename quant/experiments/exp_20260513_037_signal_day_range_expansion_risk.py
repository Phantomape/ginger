...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "related_files": [
            ...
            "experiments/logs/exp-20260513-037.json",
            "experiments/tickets/exp-20260513-037.json",
            "experiments/artifacts/exp-20260513-037_signal_day_range_expansion_risk.md",
