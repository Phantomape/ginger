...
def _experiment_record(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "related_files": [
            ...
            "experiments/logs/exp-20260516-029.json",
            "experiments/tickets/exp-20260516-029.json",
            "experiments/artifacts/exp-20260516-029_space_dual_catalyst_benchmark_breadth_trend_risk.md",
