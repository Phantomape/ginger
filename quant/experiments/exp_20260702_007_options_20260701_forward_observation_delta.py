"""exp-20260702-007: options forward observation delta for 2026-07-01.

Measurement repair only. A new OnclickMedia options chain snapshot for
2026-07-01 exists after the previous options delta refresh. This runner
...
EXPERIMENT_ID = "exp-20260702-007"
OWNER = "alpha-explore"
SLUG = "options_20260701_forward_observation_delta"
RUNNER = f"quant/experiments/exp_20260702_007_{SLUG}.py"
...
OUT_JSON = DATA_DIR / f"exp_20260702_007_{SLUG}.json"
...
RAW_CHAIN_JSONL = REPO_ROOT / "data" / "non_ohlcv" / "options_onclickmedia_chain_20260701.jsonl"
RAW_SUMMARY_JSON = REPO_ROOT / "data" / "non_ohlcv" / "options_onclickmedia_summary_20260701.json"
...
TARGET_QUOTE_DATES = ("2026-07-01",)
HORIZONS = (1, 3, 5, 10)

HYPOTHESIS = (
    "Alpha blocker: newly collected 2026-07-01 OnclickMedia options rows need "
...
TRIAL_VARIANT_ID = "post_exp20260701008_20260701_pending_rows_v1"
CHANGED_VARIABLE = "onclickmedia_options_20260701_forward_observation_delta_ledger_v1"
NEW_EVIDENCE_TYPE = "new_forward_options_snapshot_rows"
NEW_EVIDENCE_AXIS = (
    "The 2026-07-01 OnclickMedia chain file was generated after exp-20260701-008 "
    "and adds a new non-empty snapshot date (5897 contracts across 59 tickers, "
    "usable on 2026-07-02). This is not an options bucket, threshold, notional, "
...
ALLOWED_WRITE_SCOPE = [
    RUNNER,
    f"data/experiments/{EXPERIMENT_ID}/exp_20260702_007_{SLUG}.json",
...
DEFAULT_PREDICTION = {
    ...
    "confidence_reason": (
        "The 2026-07-01 chain summary is present, reports 5897 PIT-safe rows "
        ...
        "usable_trade_date is 2026-07-02."
    ),
}
...
def build_delta() -> tuple[list[dict[str, Any]], dict[str, Any]]:
    ...
    target_files = [path for path in file_audit["chain_files"] if "20260701" in path]
...
def evaluate_gate4(refresh: Mapping[str, Any], baseline: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        "passed": passed,
        "decision": (
            "accepted_measurement_repair_options_forward_observation_delta_20260701"
            if passed
            else "blocked_options_forward_observation_delta_20260701"
        ),
...
def build_payload(delta_rows: list[dict[str, Any]], refresh: dict[str, Any]) -> dict[str, Any]:
    ...
    why = (
        "The 2026-07-01 OnclickMedia snapshot normalized into new ticker-date "
        "forward observation rows. They remain alpha-enabling measurement rows "
        "because settlement is still pending for usable_trade_date 2026-07-02."
        if accepted
        else "The 2026-07-01 OnclickMedia snapshot failed one or more fixed "
    ...
    return {
        ...
        "pre_run_questions": {
            ...
            "2_history_check": {
                ...
                "exp-20260701-008": (
                    "Accepted options forward observation delta for 2026-06-30; "
                    "this run only materializes the later 2026-07-01 snapshot."
                ),
                "novelty_gate": "Reservation passed with no strong near-neighbor.",
            },
            "3_single_policy_bundle": (
                "Normalize only 2026-07-01 OnclickMedia options contracts into "
        ...
        "post_run_reflection": {
            ...
            "new_evidence_required": (
                "Wait for the 2026-07-01 rows to close with cash/SPY/QQQ "
        ...
        "related_files": [
            ...
            "quant/experiments/exp_20260701_008_options_20260630_forward_observation_delta.py",
...
def build_card(payload: Mapping[str, Any]) -> str:
    ...
    return "\n".join(
        [
            f"# {EXPERIMENT_ID}: options 2026-07-01 forward observation delta",
            "",
