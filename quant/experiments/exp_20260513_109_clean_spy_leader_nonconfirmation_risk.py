...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "related_files": [
            ...
            "docs/experiments/logs/exp-20260513-109.json",
            "docs/experiments/tickets/exp-20260513-109.json",
            "docs/experiments/artifacts/exp-20260513-109_clean_spy_leader_nonconfirmation_risk.md",
