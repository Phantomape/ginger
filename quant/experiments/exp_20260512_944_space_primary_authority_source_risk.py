...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "related_files": [
            ...
            "experiments/logs/exp-20260512-944.json",
            "experiments/tickets/exp-20260512-944.json",
            "experiments/artifacts/exp-20260512-944_space_primary_authority_source_risk.md",
