"""exp-20260622-021: Moomoo/FINRA daily short-volume imbalance attribution.
...
EXPERIMENT_ID = "exp-20260622-021"
SLUG = "finra_daily_short_volume_imbalance"
RUNNER = f"quant/experiments/exp_20260622_021_{SLUG}.py"
RUNNER_COMMAND = ".\\.venv\\Scripts\\python.exe -B " + RUNNER.replace("/", "\\")
OWNER = "alpha-explore"

DATA_DIR = REPO_ROOT / "data" / "experiments" / EXPERIMENT_ID
OUT_JSON = DATA_DIR / f"exp_20260622_021_{SLUG}.json"
...
ACTIVITY_ROWS_PATH = REPO_ROOT / "data" / "non_ohlcv" / "moomoo_daily_short_volume" / "rows.jsonl"
BASELINE_RESULT = (
    REPO_ROOT
    / "data"
    / "backtests"
...
HYPOTHESIS = (
    "Observed-only attribution: Moomoo/FINRA daily short-volume imbalance "
    "(short-volume ratio versus its own trailing history) should show monotonic "
    "next-10-trading-day paper-return separation among liquid SPY/QQQ-relative "
    "leader rows before any future default-off helper or threshold retry is "
    "justified."
)
CHANGE_TYPE = "observed_only_attribution"
MECHANISM_FAMILY = "production_visible_free_finra_daily_short_volume_candidate_pool"
TRIAL_FAMILY = "finra_daily_short_volume_imbalance_candidate_pool"
TRIAL_VARIANT_ID = "observed_only_archived_5ticker_imbalance_monotonicity_v1"
CHANGED_VARIABLE = "moomoo_finra_daily_short_volume_imbalance_default_off_candidate_source_v1"
...
NEW_EVIDENCE_TYPE = "observed_only_archived_daily_short_volume_imbalance_outcomes"
NEW_EVIDENCE_AXIS = (
    "Uses the archived Moomoo daily short-volume activity rows from "
    "exp-20260622-009 to test monotonic imbalance outcome attribution directly, "
    "rather than retuning the rejected exp-20260622-010 activity-absorption "
    "threshold bundle."
)
CAUSAL_COMPONENTS = [
    "archived activity-only daily short-volume rows",
...
ALLOWED_WRITE_SCOPE = [
    RUNNER,
    "data/experiments/exp-20260622-021/exp_20260622_021_finra_daily_short_volume_imbalance.json",
    "experiments/cards/exp-20260622-021.md",
    "experiments/manifests/exp-20260622-021.json",
    "experiments/tickets/exp-20260622-021.json",
    "experiments/logs/exp-20260622-021.json",
    ...
    return {
        ...
        "post_run_reflection": {
            ...
            "forbidden_near_neighbor_retry": (
                ...
                "threshold sweeps on the same five-ticker archive. That would "
                "repeat exp-20260622-010/021 near neighbors."
            ),
            "new_evidence_required": (
                "A valid retry needs a materially broader archived Moomoo "
                "coverage set, PIT borrow fee/utilization or loan-availability "
                "data, options/flow confirmation, or closed forward "
