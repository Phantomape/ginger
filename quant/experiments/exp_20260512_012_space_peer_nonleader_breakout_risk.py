...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "related_files": [
            ...
            "experiments/logs/exp-20260512-012.json",
            "experiments/tickets/exp-20260512-012.json",
            "experiments/artifacts/exp-20260512-012_space_peer_nonleader_breakout_risk.md",
