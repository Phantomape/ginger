"""exp-20260512-012: Space peer-nonleader breakout risk allocation.
...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "related_files": [
            "quant/experiments/exp_20260512_012_space_peer_nonleader_breakout_risk.py",
            "data/experiments/exp-20260512-012/space_peer_nonleader_breakout_risk.json",
            "docs/experiments/logs/exp-20260512-012.json",
            "docs/experiments/tickets/exp-20260512-012.json",
            "docs/experiments/artifacts/exp-20260512-012_space_peer_nonleader_breakout_risk.md",
