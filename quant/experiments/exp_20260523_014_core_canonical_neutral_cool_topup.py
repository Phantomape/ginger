"""exp-20260523-014: core canonical neutral/cool top-up scout.

Alpha search. Tests whether already-qualified core stock signals with a
production-computable canonical state vector of neutral leadership and cool
...
EXPERIMENT_ID = "exp-20260523-014"
STEM = "core_canonical_neutral_cool_topup"
MULTIPLIER_KEY = "canonical_neutral_leadership_cool_risk_topup_applied"
...
VARIANTS = OrderedDict(
    [
        ("canonical_neutral_cool_topup_1010", {"multiplier": 1.01}),
        ("canonical_neutral_cool_topup_1025", {"multiplier": 1.025}),
        ("canonical_neutral_cool_topup_1050", {"multiplier": 1.05}),
        ("canonical_neutral_cool_topup_1075", {"multiplier": 1.075}),
    ]
)

TARGET_LEADERSHIP_STATE = "neutral"
...
def _make_enrich_wrapper(original: Callable[..., list[dict[str, Any]]]):
    def wrapped(signals, features_dict, atr_target_mult=None):
        ...
        for sig in enriched:
            ...
            sig["canonical_neutral_leadership_cool_risk_state"] = (
...
def _apply_topup_to_sizing(
    ...
    if sig.get("canonical_neutral_leadership_cool_risk_state") is not True:
        return sig, None
    ...
    sizing["canonical_neutral_leadership_cool_risk_state"] = True
    sizing["canonical_neutral_leadership_baseline_shares"] = old_shares
    sizing["canonical_neutral_leadership_desired_shares"] = desired_shares
    sizing["canonical_neutral_leadership_cap_shares"] = cap_shares
    sizing["canonical_neutral_leadership_new_shares"] = new_shares
...
def _rejection_reason(gate: dict[str, Any]) -> str:
    if gate["adjusted_signal_count"] < gate["guardrails"]["min_adjusted_signal_count"]:
        return (
            ...
            "neutral-leadership/cool-risk state did not touch enough sized core signals."
        )
...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "hypothesis": (
            ...
            "already-qualified core signals where leadership is neutral while "
        ...
        "change_summary": (
            ...
            "non-Commodity core signals where leadership_vector=neutral and "
        ...
        "gate_questions": {
            "1_alpha_hypothesis": (
                "risk/capital allocation: neutral leadership plus cool risk "
                "canonical state may mark diversified top-up candidates among existing entries."
            ),
            "2_history_check": (
                "exp-20260523-013 tested strong-leadership/cool-risk top-up and "
                "failed Gate 4. This is the distinct neutral-leadership/cool-risk "
                "state suggested by the entry-day attribution breadth, not a scalar "
                "retry on the same vector cell."
            ),
            "3_single_causal_variable": (
                "post-sizing multiplier for canonical neutral leadership + cool risk state"
            ),
            ...
            "5_reproducibility": (
                ...
                "exp_20260523_014_core_canonical_neutral_cool_topup.py"
            ),
        },
        "gate1": {
        ...
        "next_retry_requires": (
            [
            "Do not retry adjacent canonical neutral/cool scalar values on the same frozen windows without new forward rows or a materially distinct vector state.",
        ...
        "related_files": [
            "quant/experiments/exp_20260523_014_core_canonical_neutral_cool_topup.py",
