...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "related_files": [
            ...
            "experiments/logs/exp-20260513-021.json",
            "experiments/tickets/exp-20260513-021.json",
            "experiments/artifacts/exp-20260513-021_space_satellite_connectivity_theme_risk.md",
