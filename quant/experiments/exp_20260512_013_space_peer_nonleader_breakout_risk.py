...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "related_files": [
            ...
            "experiments/logs/exp-20260512-013.json",
            "experiments/tickets/exp-20260512-013.json",
            "experiments/artifacts/exp-20260512-013_space_peer_nonleader_breakout_risk.md",
