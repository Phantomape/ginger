...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "related_files": [
            ...
            "experiments/logs/exp-20260512-041.json",
            "experiments/tickets/exp-20260512-041.json",
            "experiments/artifacts/exp-20260512-041_space_financing_dilution_profile_risk.md",
