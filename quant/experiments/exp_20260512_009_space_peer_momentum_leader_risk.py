...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "related_files": [
            ...
            "experiments/logs/exp-20260512-009.json",
            "experiments/tickets/exp-20260512-009.json",
            "experiments/artifacts/exp-20260512-009_space_peer_momentum_leader_risk.md",
