...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "related_files": [
            ...
            "experiments/logs/exp-20260512-015.json",
            "experiments/tickets/exp-20260512-015.json",
            "experiments/artifacts/exp-20260512-015_space_breakout_52w_proximity_risk.md",
