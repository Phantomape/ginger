...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "related_files": [
            ...
            "experiments/logs/exp-20260513-001.json",
            "experiments/tickets/exp-20260513-001.json",
            "experiments/artifacts/exp-20260513-001_core_breakout_strong_volume_risk.md",
