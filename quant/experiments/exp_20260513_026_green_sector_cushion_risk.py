...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "related_files": [
            ...
            "docs/experiments/logs/exp-20260513-026.json",
            "docs/experiments/tickets/exp-20260513-026.json",
            "docs/experiments/artifacts/exp-20260513-026_green_sector_cushion_risk.md",
