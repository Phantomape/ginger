...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "related_files": [
            ...
            "experiments/logs/exp-20260513-027.json",
            "experiments/tickets/exp-20260513-027.json",
            "experiments/artifacts/exp-20260513-027_signal_day_green_slot_priority.md",
