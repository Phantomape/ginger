"""exp-20260512-006: SEC financial-report T+1 paper notional.
...
EXPERIMENT_ID = "exp-20260512-006"
STEM = "exp_20260512_006_sec_financial_report_event_notional"
    ...
    *,
    ...
    for as_of, prices in prices_by_date.items():
        ...
        queue = {
            ...
            "rule_version": "exp-20260512-006-replay",
            "enabled": False,
            "asof_date": as_of,
