...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "related_files": [
            ...
            "docs/experiments/logs/exp-20260514-006.json",
            "docs/experiments/tickets/exp-20260514-006.json",
            "docs/experiments/artifacts/exp-20260514-006_spy_volatility_contraction_core_risk.md",
