...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "related_files": [
            ...
            "experiments/logs/exp-20260512-031.json",
            "experiments/tickets/exp-20260512-031.json",
            "experiments/artifacts/exp-20260512-031_space_iwm_relative_momentum_risk.md",
