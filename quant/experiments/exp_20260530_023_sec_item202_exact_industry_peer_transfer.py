"""exp-20260530-023: SEC Item 2.02 exact-industry peer transfer.
...
EXPERIMENT_ID = "exp-20260530-023"
...
OUT_JSON = OUT_DIR / f"exp_20260530_023_{STEM}.json"
    ...
    payload.update(
        {
            ...
            "gate_questions": {
                ...
                "5_reproducibility": (
                    ...
                    "exp_20260530_023_sec_item202_exact_industry_peer_transfer.py"
                ),
            },
