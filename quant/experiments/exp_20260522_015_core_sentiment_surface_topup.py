"""exp-20260522-015: core sentiment-surface top-up scout.

Alpha search. Tests whether already-qualified core stock signals in a
constructive non-theme sentiment surface deserve a small cap-aware risk top-up.
...
EXPERIMENT_ID = "exp-20260522-015"
STEM = "core_sentiment_surface_topup"
MULTIPLIER_KEY = "sentiment_surface_constructive_risk_multiplier_applied"
...
VARIANTS = OrderedDict(
    [
        ("constructive_sentiment_topup_1025", {"multiplier": 1.025}),
        ("constructive_sentiment_topup_1050", {"multiplier": 1.05}),
        ("constructive_sentiment_topup_1075", {"multiplier": 1.075}),
        ("constructive_sentiment_topup_1100", {"multiplier": 1.10}),
    ]
)

EXCLUDED_SECTORS = {"ETF", "Commodities"}
TARGET_SENTIMENTS = {"healthy_trend", "low_vol_grind"}
...
def _apply_topup_to_sizing(
    ...
    sizing["sentiment_surface_constructive_state"] = True
    ...
    sizing["sentiment_surface_constructive_baseline_shares"] = old_shares
    sizing["sentiment_surface_constructive_new_shares"] = new_shares
...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "decision": decision,
        "hypothesis": (
            "Core stock signals in constructive non-theme sentiment surfaces "
            "may deserve a small cap-aware risk top-up because broad trend "
            "quality should matter more than single-name path shape. The rule "
        ...
        "change_summary": (
            ...
            "non-ETF/non-Commodity core signals classified as healthy_trend or "
            "low_vol_grind."
        ),
        ...
        "parameters": {
            ...
            "field_definition": (
                "constructive market-sentiment proxy inferred from replay-visible "
        ...
        "production_impact": {
            ...
            "promotion_required_if_accepted": (
                "Move sentiment-surface constructive state and risk top-up into "
        ...
        "next_retry_requires": (
            [
                "Do not retry adjacent constructive sentiment multipliers on the same frozen windows without forward rows or a richer persisted market-context field.",
        ...
        "related_files": [
            "quant/experiments/exp_20260522_015_core_sentiment_surface_topup.py",
