"""exp-20260707-005: daily-equity replay for the rank-4 portfolio-lane candidate.

This consumes the observed-only ranking from exp-20260706-022. It does not
retune the receivables DSO source from exp-20260616-021 and does not change
...
EXPERIMENT_ID = "exp-20260707-005"
OWNER = "alpha-explore"
LANE = "alpha_search"
STEM = "receivables_dso_daily_equity_overlay"
STATUS_POSITIVE = "observed_only_positive_receivables_dso_daily_equity_lead_not_activation_ready"
STATUS_REJECTED = "observed_only_rejected_receivables_dso_daily_equity_overlay"
DECISION_POSITIVE = "observed_only_positive_receivables_dso_daily_equity_overlay"
DECISION_REJECTED = "observed_only_rejected_receivables_dso_daily_equity_overlay"

TRIAL_FAMILY = "portfolio_covariance_daily_equity_overlay"
TRIAL_VARIANT_ID = "receivables_dso_rank4_10pct_daily_equity_overlay_v1"
CHANGED_VARIABLE = "receivables_dso_rank4_portfolio_daily_equity_overlay_v1"
...
NEW_EVIDENCE_AXIS = (
    ...
    "overlay gate: consume exp-20260706-022 rank-4 receivables DSO rows "
    "from exp-20260616-021. Prior daily-equity overlays consumed "
    "fixed-asset-turnover, deferred-revenue, purchase-obligation, "
    "sector-breadth, and FINRA short-pressure; this does not retune overlay "
    "weight, thresholds, top-N, hold days, or Companyfacts source behavior."
)

OUT_DIR = REPO_ROOT / "data" / "experiments" / EXPERIMENT_ID
OUT_JSON = OUT_DIR / f"exp_20260707_005_{STEM}.json"
...
TARGET_SOURCE_ARTIFACT = (
    "data/experiments/exp-20260616-021/"
    "exp_20260616_019_receivables_dso_collection_improvement.json"
)
TARGET_SOURCE_EXPERIMENT_ID = "exp-20260616-021"
...
PREDICTION = {
    ...
    "confidence_reason": (
        "exp-20260706-022 ranked receivables DSO fourth with positive "
        "exit-cashflow portfolio proxy and modest drawdown delta, but prior "
        "daily-MTM overlay attempts often turned proxy edge into window "
        "regression; this consumes a materially new ranked family without "
        "retuning thresholds or overlay weight."
    ),
    "recorded_at": "2026-07-07T04:07:51+00:00",
}

HYPOTHESIS = (
    "Portfolio lane: the exp-20260706-022 rank-4 receivables DSO "
    "collection-improvement rejected source may add value as a fixed 10 "
    "percent paper overlay when replayed with true daily mark-to-market "
    "equity, without retuning the Companyfacts source or overlay weight."
)
ALPHA_HYPOTHESIS = (
...
RUNNER = f"quant/experiments/exp_20260707_005_{STEM}.py"
RUNNER_COMMAND = f".\\.venv\\Scripts\\python.exe -B {RUNNER}"
RUNNER_WINDOWS = f"quant\\experiments\\exp_20260707_005_{STEM}.py"

CHANGED_FILES = [
    RUNNER,
    f"data/experiments/{EXPERIMENT_ID}/exp_20260707_005_{STEM}.json",
    ...
    payload = {
        ...
        "post_run_reflection": {
            ...
            "forbidden_near_neighbor_retry": (
                "Do not rerun receivables DSO portfolio overlays by changing "
                "overlay weight, DSO thresholds, collection-improvement "
                "thresholds, fact age, prior gap, RS/close/volume gates, "
                "top-N, hold days, cooldown, correlation cutoffs, or source "
                "filters. A legal retry needs materially new ranked families, "
                "fresh closed forward replacement-value rows for this "
                "unchanged source, or a shared paper helper/activation-envelope "
                "experiment."
            ),
        ...
        "next_retry_requires": [
            ...
            "materially more closed receivables DSO forward replacement-value rows",
            "no overlay-weight, DSO-threshold, top-N, hold-day, source-filter, or correlation retune",
        ],
