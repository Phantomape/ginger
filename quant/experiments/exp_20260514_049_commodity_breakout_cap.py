"""exp-20260514-049: Commodity breakout cap scout.
...
EXPERIMENT_ID = "exp-20260514-049"
...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "gate_questions": {
            ...
            "5_reproducibility": (
                ".venv\\Scripts\\python.exe quant\\experiments\\exp_20260514_049_commodity_breakout_cap.py"
            ),
        },
        "backtest_protocol": {
...
def persist(payload: dict[str, Any]) -> None:
    ...
    ticket_path.write_text(
        json.dumps(ticket, ensure_ascii=True, sort_keys=True, indent=2) + "\n",
        encoding="utf-8",
    )
