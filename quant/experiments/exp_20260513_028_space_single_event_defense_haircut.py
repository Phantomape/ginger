...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "related_files": [
            ...
            "experiments/logs/exp-20260513-028.json",
            "experiments/tickets/exp-20260513-028.json",
            "experiments/artifacts/exp-20260513-028_space_single_event_defense_haircut.md",
