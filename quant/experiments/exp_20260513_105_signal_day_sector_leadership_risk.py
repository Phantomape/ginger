...
def run() -> dict[str, Any]:
    ...
    payload = {
        ...
        "related_files": [
            ...
            "experiments/logs/exp-20260513-105.json",
            "experiments/tickets/exp-20260513-105.json",
            "experiments/artifacts/exp-20260513-105_signal_day_sector_leadership_risk.md",
