...
SIZING_MULTIPLIER_KEYS = (
    ...
    "scarce_slot_rank1_risk_multiplier_applied",
    "ample_slot_stock_rank1_risk_multiplier_applied",
    ...
    "tsm_core_risk_multiplier_applied",
    "isrg_core_risk_multiplier_applied",
    ...
    "trend_gold_near_high_max_position_pct_applied",
