...
TREND_FINANCIALS_SECTOR_LEADER_MAX_POSITION_PCT = 0.50
TREND_FINANCIALS_MID_DISPERSION_LEADER_MAX_POSITION_PCT = 0.55
...
TREND_TECH_DTE_RISK_MULTIPLIER = 0.125
...
TREND_GOLD_NEAR_HIGH_TICKERS = ("GLD", "IAU")
TREND_GOLD_NEAR_HIGH_MAX_POSITION_PCT = 0.575
...
GREEN_DECEL_QUALITY_NONCONSUMER_TQS_MIN = 0.95
GREEN_DECEL_QUALITY_NONCONSUMER_EXCLUDED_SECTORS = (
    "Communication Services",
    "Consumer Discretionary",
)
GREEN_DECEL_QUALITY_NONCONSUMER_RISK_MULTIPLIER = 1.025
...
TREND_PRICE_VS_200MA_EXTENSION_RISK_MULTIPLIER = 1.125
...
CLEAN_SPY_CAP_ONLY_RS20_LEADER_MAX_POSITION_PCT = 0.70
