...
DEFAULT_STATE_PATH = Path("data/sec_negative_event_sleeve_paper_state.json")
DEFAULT_SNAPSHOT_LOG_PATH = Path("data/sec_negative_event_sleeve_paper_snapshots.jsonl")
